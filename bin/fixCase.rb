...
# This script takes a BIB file exported by Bookends, or a JSON file generated by 
# pandoc-citeproc from a Bookends BIB file, and uses two lists of phrases to selectively
# protect case. 
# `keepCase` protects a word as long as it is that case, for example "ON" will be protected but "on" will not
# `enforceCase` will always protect case irrespective of the original.
#
